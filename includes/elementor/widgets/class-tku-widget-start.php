...
class TKU_Widget_Start extends Widget_Base {
    public function get_name() { return 'tku_start'; }
    public function get_title() { return 'Ügy indítása (Temetkezés)'; }
    ...
    protected function register_controls() {
        ...
        $this->add_control('subtitle', [
            ...
            'rows' => 3,
            'default' => 'Pár perc alatt elindítható. A folytatáshoz emailben küldünk ügyazonosítót és linket.',
